...
\emph{radiated}. (Injection attacks are another matter and will be discussed in
...
therefore follows an inverse square law---distance is the defender's most
valuable ally. Like other electromagnetic radiation, wavelength is important in
optical TEMPEST. Wavelengths between 350--\SI{700}{\nano\metre} are visible to
humans; wavelengths shorter than \SI{350}{\nano\metre} or longer than
\SI{700}{\nano\metre} are not. Visual indicators---such as light emitting
diodes, or LEDs---obviously must always be at visible wavelengths. But
...
be at visible wavelenghths, whilst intentional sources sometimes have the
flexibility to employ invisible ones. (The distinction can be useful when
forensically attributing intent.)

Light sources vulnerable to optical TEMPEST include visual
