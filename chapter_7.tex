...
information impressed onto the visual indicator. It may originate from storage
device activity (disk drives, tape drives, or emulated storage devices in
memory), serial communication channels---very common---or network interfaces.
Serial comms were where the first detectable optical TEMPEST emanations were
found.
